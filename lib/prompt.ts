...
{
  "aboutProject": "string (2-4 sentences: a detailed, factual summary of what this specific repository is, what problem it solves, and who uses it — base this on the README and description, NOT on the profiler tool itself)",
  "projectGoal": "string (1-2 sentences: the core mission or goal of this project — why does it exist?)",
  "keyFeatures": ["string (3-5 bullet points listing the main features or capabilities of this project, inferred from the README and commit messages)"],
  "useCases": ["string (2-3 real-world use cases or target audiences for this project)"],
